  ...
  module V1
    class ClaDashboardsController < ApplicationController
      ...
      def students_with_details
        ...
        students_with_details = students.map do |student|
      ...
      
          {
            ...
            user_submission_percentage: ClaDashboardAssignmentStatsHelper.user_submission_percentage(user_id),
            user_attendance_percentage: ClaDashboardAttendanceStatsHelper.user_attendance_percentage(user_id)
          }
        end
      ...
      def student_details
        ...
        render json: {
          student: student,
          course_completion_rate: course_completion_rate_stats,
          user_score_percentage: user_score_percentage_stats,
          user_submission_percentage: user_submission_percentage_stats,
          user_attendance_percentage: user_attendance_percentage_stats
        }, status: :ok
      end      
    end
  end
